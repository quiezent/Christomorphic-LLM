...
This glossary translates project terms for readers coming from different backgrounds.
...
| Term | Meaning |
|---|---|
| FIRST_ACT | The first public movement of an answer, scored before later wording can repair or obscure it |
| Selector | Ability to infer the right route or Scripture family from bare pressure |
| Selector-then-canon | Infer the route first, then let that inferred canon family govern public movement |
| Continuation completeness | The answer remains faithful after the opening sentence |
...
| Term | Meaning |
|---|---|
| Other lords | Rival teloi such as influence, income, platform, business blessing, private oracle behavior, prophetic certainty, secrecy, safety delay, or AI mediation |
| Jabez pressure | Biblical vocabulary conscripted into worldly enlargement or prosperity technique |
| Isaiah 26 spine | A stricter answer movement: righteous path, guarded city, stayed mind, Name/remembrance, rejection of other lords, God's lifted hand, God-glorifying enlargement, travail, resurrection hope, and Christ's risen Name |
| Boringness failure | A true but flattening answer that erases the passage's preserved details |

## Dataset Terms

| Term | Meaning |
|---|---|
| ESV/NKJV co-primary corpus | ESV and NKJV are used together as paired Scripture surfaces |
| BibleAtlas | Study metadata for book movement, monographs, metrics, slices, and eval gates; not Scripture target text |
